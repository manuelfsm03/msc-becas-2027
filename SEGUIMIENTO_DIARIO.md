...
- 25-sep: FOCO TOTAL EN HSG MEcon. Plan completo en `HSG_MECON_plan_aplicacion.md`. Objetivo: 1ª ronda (postular antes del 30-nov, decisión antes del 31-dic) para llegar temprano a Best Talents. No piden GRE (el promedio pesa doble), ni cartas de recomendación, ni certificado de inglés. Lo que decide es el 30% de extracurriculares CON comprobantes → pedir constancias ya. NUEVO: piden el título secundario traducido → sumarlo al encargo de la traductora. Tareas de esta semana: traductora (secundario + plazo + apostilla), fecha del analítico en FCE, pedir constancias; el 1-oct crear la cuenta en el portal.
- 25-sep: contabilidad cubierta: aprobó una materia en FCE-UBA (requisito de HSG).
- 25-sep: bloque 5 del SOP escrito en borrador para HSG, Warwick, Bristol, Southampton, Glasgow y Birmingham (`SOP_bloque5_por_universidad.md` y artefacto *Credible Enough to Act*). Birmingham: MSc Economics, ángulo experimental (Drouvelis + Bhatiya + Bandyopadhyay). Falta: y los NEED de los bloques 4 y 6.
- 25-sep: paneo de profes y centros en las 6 universidades (`PANEO_profes_centros_2027.md`). Zylberberg confirmado en Bristol. Propuestas: reescribir Glasgow con macro empírica (Tsoukalas, Baskaya, Korobilis); Southampton: de Groot en lugar de Olmo; Bristol: Weining Wang en lugar de Zylberberg; Warwick: Lanata-Briones opcional. Falta que Manuel decida cuáles aplica.
