...
- 25-sep: bloque 5 del SOP escrito en borrador para HSG, Warwick, Bristol, Southampton, Glasgow y Birmingham (`SOP_bloque5_por_universidad.md` y artefacto *Credible Enough to Act*). Birmingham: MSc Economics, reescrito con ángulo fiscal (Rossi + Banerjee). Falta: confirmar la identificación del paper de Rossi, re-chequear Zylberberg, y los NEED de los bloques 4 y 6.
