...
| `PANEO_profes_centros_2027.md` | **Paneo de profes y centros en las 6 universidades (25-sep-2026)**, verificado contra las páginas oficiales. Lo nuevo que cambia cartas (Glasgow con macro empírica; de Groot en Southampton; Weining Wang en Bristol; Lanata-Briones en Warwick; Kutz y Mareckova en HSG), los 6 profes cuyo trabajo repite la pregunta de la carta, y una vista por track. Las cartas no se tocaron: son propuestas. | 2026-09-25 |
| `SOP_bloque5_por_universidad.md` · `SOP_credible_enough.html` | **Bloque 5 del SOP escrito para las 6 universidades** (HSG, Warwick, Bristol, Southampton, Glasgow, Birmingham), con los profes re-verificados el 25-sep. El `.html` es la fuente del artefacto web *Credible Enough to Act* (https://claude.ai/artifact/6daT3A2wHCGypprqkjQLFx), que tiene la carta entera. | 2026-09-25 |
